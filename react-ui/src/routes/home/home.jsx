        ...
        <>
          ...
          <div className="front-arts">
            ...
            <ul>
              ...
              <li><h4><a href="https://dev.to/nipu/tips-tricks-of-javascript-react-3ncc" target="_blank" rel="noreferrer" style={{color: "black"}}>TIPS and TRICKS OF JAVASCRIPT and REACT - DEV Community</a></h4></li>
